...
class AppStore extends Component {
  ...
  getFilterData = searchedApps => {
    const {activeId} = this.state
    const filteredDate = searchedApps.filter(item => item.category === activeId)
    return filteredDate
  }
  ...
  render() {
    ...
    const filterDetails = this.getSearchResults()
    const projectfilterdetails = this.getFilterData(filterDetails)
      ...
      <div className="container">
        ...
        <div className="app-store">
          ...
          <ul className="item-card">
            {projectfilterdetails.map(eachItem => (
